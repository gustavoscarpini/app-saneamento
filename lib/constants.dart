...
const String KEY_BIOMETRIA = "biometria_nfse";

const List<Color> gradientColorButton = [Color(0xFFF36C2B), Color(0xFFF36C2B)];

const List<Color> botaoCadastrarNovo = [Color(0xFF2D9ABA), Color(0xFF1777C7)];

const List<Color> gradientLightBlue = [Color(0xFF1777C7), Color(0xFF2D9ABA)];
